...
graph LR
    ...
    E --- 4
```
4. Найдем в двудольном графе совершенное парасочетание с помощью волнового метода и чередующегося дерева. 
...
Необходимо найти минимальный элемент из строк, включенных во множество X и столбцов, не включенных во множество Y. В нашем случае это будут строки C, D и столбцы 1, 5. Минимальный элемент 1, расположен в строке C и столбце 1. 
