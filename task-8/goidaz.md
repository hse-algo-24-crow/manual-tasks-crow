...
- **Задача B:** имеет нули в столбцах **3** и **4** → назначаем **B → 3**
- **Задача C:** имеет ноль только в столбце **5** → назначаем **C → 5**
- **Задача D:** имеет нули в столбцах **2** и **3**; столбец **3** уже занят (B → 3), поэтому назначаем **D → 2**
- **Задача E:** имеет нули в столбцах **1** и **4**; столбец **1** уже занят (A → 1), поэтому назначаем **E → 4**
