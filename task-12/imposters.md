...
Максимальный штраф 4, выберем ребро CB, как ребро с максимальным штрафом.
##### Узел №4
---
Узел №4 с исключением ребра CB имеет оценку 37 + 4 (штраф) = 41
##### Узел №5
---
...
- удалим строку C,
- удалим столбец B,
- Заменим на бесконечность значение BC. (BE, чтобы не допустить цикла ECBE)
...
Максимальный штраф 6, выберем ребро AE, как ребро с максимальным штрафом.

##### Узел №6
---
Узел №6 с исключением ребра AE имеет оценку 37 + 6 (штраф) = 43
...
- удалим строку A,
- удалим столбец E,
- Заменим на бесконечность значение EA. (тк сейчас уже цикл состоит из AECBA, то нужно заменить ребро BA)
...
Оценка узла 7 = 37 + 1 (редукция) = 38
...
Максимальный штраф ∞, выберем ребро BD, как ребро с максимальным штрафом.
##### Узел №8
---
Узел №8 с исключением ребра BD имеет оценку 38 + ∞ (штраф) = ∞
